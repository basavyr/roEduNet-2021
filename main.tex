...
\par Now that the core stages of the implementation were sketched (see also Fig. \ref{fig-operation-mode}), it is instructive to.

\begin{figure*}[htbp]
    \centering
    \includegraphics[scale=0.8]{figs/alert_system_operation_mode.pdf}
